...
public final class Util {
	 ...
	 * @param range Maximum distance between the two to consider them in range
	 * @return true if the two points are in the given range or not, false otherwise
	 */
	//public static boolean pointsInRange(Point p1, Point p2, double range) {
	//	return Math.sqrt(Math.pow(p1.x - p1.y, 2) + Math.pow(p2.x - p2.y, 2)) < range;
	//}
}
