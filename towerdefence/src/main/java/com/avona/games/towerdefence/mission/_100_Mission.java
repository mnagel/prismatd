	...
	protected WaveEnemyConfig[][] loadEnemyWaves() {
		return new WaveEnemyConfig[][]{
				new WaveEnemyConfig[]{
						...
						new WaveEnemyConfig(new PurpleEnemy(this, 1),
								0.35f),
						new WaveEnemyConfig(new GreenEnemy(this, 1), 0.35f),
						new WaveEnemyConfig(new PurpleEnemy(this, 1),
								0.35f),
						...
						new WaveEnemyConfig(new PurpleEnemy(this, 1),
								0.35f)},
				new WaveEnemyConfig[]{
						new WaveEnemyConfig(new GreenEnemy(this, 2), 0.35f),
						new WaveEnemyConfig(new PurpleEnemy(this, 2),
								0.35f),
						new WaveEnemyConfig(new GreenEnemy(this, 2), 0.35f),
						new WaveEnemyConfig(new PurpleEnemy(this, 2),
								0.35f),
						...
						new WaveEnemyConfig(new PurpleEnemy(this, 2),
								0.35f)},
				new WaveEnemyConfig[]{
						new WaveEnemyConfig(new GreenEnemy(this, 3), 0.35f),
						new WaveEnemyConfig(new PurpleEnemy(this, 3),
								0.35f),
						new WaveEnemyConfig(new GreenEnemy(this, 3), 0.35f),
						new WaveEnemyConfig(new PurpleEnemy(this, 3),
								0.35f),
						...
						new WaveEnemyConfig(new PurpleEnemy(this, 3),
								0.35f)},
				new WaveEnemyConfig[]{
						new WaveEnemyConfig(new GreenEnemy(this, 4), 0.35f),
						new WaveEnemyConfig(new PurpleEnemy(this, 4),
								0.35f),
						new WaveEnemyConfig(new GreenEnemy(this, 4), 0.35f),
						new WaveEnemyConfig(new PurpleEnemy(this, 4),
								0.35f),
